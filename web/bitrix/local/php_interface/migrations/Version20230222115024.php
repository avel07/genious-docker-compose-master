...
class Version20230222115024 extends Version
{
  ...
  'ELEMENT_ADD' => 'Добавить пункт меню',
  'ELEMENT_EDIT' => 'Изменить пункт меню',
  'ELEMENT_DELETE' => 'Удалить пункт меню',
